...
const deleteEvent = async (req, res = response) => {
    ...
    try {
        ...
        // check if the person that created the event matches with the one that is deleting
        ...
        // if reaches this point, it is OK and the person can delete the event

        await Event.findByIdAndDelete(eventId);

        res.json({
            ok: true,
            msg: 'The event been deleted succesfully'
        })
